...
try:
    run_data(imei="868373070929734", inverter_serial="2304158510")
except:
    print("error")
...
try:
    run_data(imei="868373072938758", inverter_serial="2503292183")
except:
    print("error")
    #error_handle(imei="868373072938758", error="0")
