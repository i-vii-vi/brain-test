...
try:
    run_data(imei="868373070929262", inverter_serial="2210265161")
except:
    print("error")
    #error_handle(imei="868373070929262", error="0")
...
try:
    run_data(imei="868373070936036", inverter_serial="2501124132")
except:
    print("error")
    #error_handle(imei="868373070931292", error="0")

try:
    run_data(imei="868373072915533", inverter_serial="2304288411")
except:
    print("error")
...
try:
    run_data(imei="868373072927538", inverter_serial="2304102353")
except:
    print("error")
    #error_handle(imei="868373070930823", error="0")
...
try:
    ...
    print("error")
    #error_handle(imei="868373070933900", error="0")

try:
    run_data(imei="868373072922430", inverter_serial="2209182750")
except:
    print("error")
    #error_handle(imei="868373072922430", error="0")

try:
    run_data(imei="868373072938576", inverter_serial="2209255170")
except:
    print("error")
    #error_handle(imei="868373072938576", error="0")

try:
    run_data(imei="868373070931219", inverter_serial="2302098560")
except:
    print("error")
    #error_handle(imei="868373070931219", error="0")

try:
    run_data(imei="868373070934429", inverter_serial="2302181309")
except:
    print("error")
    #error_handle(imei="868373070934429", error="0")

try:
    run_data(imei="868373070934486", inverter_serial="2211176341")
except:
    print("error")
    #error_handle(imei="868373070934486", error="0")

try:
    run_data(imei="868373070927092", inverter_serial="2303078306")
except:
    print("error")
    #error_handle(imei="868373070927092", error="0")

try:
    run_data(imei="868373070934437", inverter_serial="2209112349")
except:
    print("error")
    #error_handle(imei="868373070934437", error="0")

try:
    run_data(imei="868373070934619", inverter_serial="2303250346")
except:
    print("error")
...
try:
    run_data(imei="868373070934825", inverter_serial="2209233522")
except:
    print("error")
    #error_handle(imei="868373070934825", error="0")

try:
    run_data(imei="868373072918453", inverter_serial="2304134245")
except:
    print("error")
    #error_handle(imei="868373072918453", error="0")

try:
    run_data(imei="868373070933553", inverter_serial="2304210454")
except:
    print("error")
...
try:
    ...
    print("error")
    #error_handle(imei="868373070936036", error="0")
...
try:
    run_data_deye3p(imei="868373070929734", inverter_serial="2304158510")
except:
    print("error")
    #error_handle(imei="868373070929734", error="0")

try:
    run_data(imei="868373072919980", inverter_serial="2304124473")
except:
    print("error")
    #error_handle(imei="868373072919980", error="0")

try:
    run_data(imei="868373070928769", inverter_serial="2503292183")
except:
    print("error")
...
try:
    ...
    print("error")
    #error_handle(imei="868373070929676", error="0")

try:
    run_data(imei="868373070934890", inverter_serial="2302160263")
except:
    print("error")
    #error_handle(imei="868373070934890", error="0")

try:
    run_data(imei="868373070930435", inverter_serial="2211127459")
except:
    print("error")
...
try:
    run_data(imei="868373072930144", inverter_serial="2209253705")
except:
    print("error")
    #error_handle(imei="868373070934213", error="0")
...
#except:
#    print("error")
    #error_handle(imei="868373070927662", error="0")

#try:
#    run_data(imei="868373070926904", inverter_serial="2302098679")
#except:
#    print("error")
    #error_handle(imei="868373070926904", error="0")
