...
try:
    CLIENT_ID = "brain-868373072922265"
    imei_number = "868373072922265"
    run_data(imei="868373072922265", inverter_serial="2304144545")
except Exception as e:
    print(str(e))


try:
    CLIENT_ID = "brain-868373070931334"
    imei_number = "868373070931334"
    run_data(imei="868373070931334", inverter_serial="1031170238130085")
except Exception as e:
    print(str(e))
...
try:
    CLIENT_ID = "brain-868373070929734"
    imei_number = "868373070929734"
...
try:
    ...
    imei_number = "868373070929676"
    run_data(imei="868373070929676", inverter_serial="2501142533")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373070934890"
    imei_number = "868373070934890"
    run_data(imei="868373070934890", inverter_serial="2302160263")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373072914858"
    imei_number = "868373072914858"
    run_data(imei="868373072914858", inverter_serial="2305056549")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373072921846"
    imei_number = "868373072921846"
    run_data(imei="868373072921846", inverter_serial="2506025009")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373070916525"
    imei_number = "868373070916525"
    run_data(imei="868373070916525", inverter_serial="1031200238020118")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373070928264"
    imei_number = "868373070928264"
    run_data(imei="868373070928264", inverter_serial="2304276665")
except Exception as e:
    print(str(e))

try:
    CLIENT_ID = "brain-868373072926118"
    imei_number = "868373072926118"
    run_data(imei="868373072926118", inverter_serial="2501123372")
except Exception as e:
    print(str(e))
...
try:
    CLIENT_ID = "brain-868373072940416"
    imei_number = "868373072940416"
...
try:
    CLIENT_ID = "brain-868373072927504"
    imei_number = "868373072927504"
    run_data(imei="868373072927504", inverter_serial="1031200239090251")
except Exception as e:
    print(str(e))
